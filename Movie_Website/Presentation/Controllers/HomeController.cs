...
namespace Movie_Website.Presentation.Controllers
{
	public class HomeController : Controller
	{
		...
		public HomeController(ApplicationContext context,
			IMovieService movie, INewsService newsService)
		{
			_db = context;
			_movieService = movie;
		...
		#region Top movies
		public async Task<IActionResult> RecentllyMovies()
		{
			TempData["RecentllyMovies"] = "active";

			return View(await _movieService.GetTopMovies());
		}
		#endregion
	}
}
